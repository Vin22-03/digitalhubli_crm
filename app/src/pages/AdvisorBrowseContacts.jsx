...
function AdvisorBrowseContacts() {
  ...
  const handleUseInDashboard = (contact) => {
  navigate("/advisor", {
    state: {
      prefillContact: {
        clientName: contact.name || "",
        clientMobile: contact.phone || "",
        age: contact.age || "",
      },
    },
  });
      ...
      <span className="text-sm text-slate-500">—</span>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <button
  type="button"
  onClick={() => handleUseInDashboard(contact)}
  className="rounded-xl border border-blue-200 bg-white px-3 py-2 text-xs font-semibold text-blue-700 transition hover:bg-blue-50"
...
{editingContact && (
  <div className="fixed inset-0 z-50 bg-black/35 backdrop-blur-[2px]">
    ...
    <div className="absolute inset-x-0 bottom-0 mx-auto flex max-h-[92dvh] w-full max-w-2xl flex-col overflow-hidden rounded-t-[28px] border border-blue-100 bg-white shadow-[0_-20px_60px_rgba(15,23,42,0.18)] sm:inset-y-auto sm:top-1/2 sm:bottom-auto sm:-translate-y-1/2 sm:rounded-[24px]">
      <div className="flex items-center justify-between border-b border-blue-100 px-4 py-4 sm:px-6 sm:py-5">
        <div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 sm:p-6">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <input
            ...
            className="rounded-2xl border border-blue-100 bg-[#f8fbff] px-4 py-3 text-slate-700 outline-none sm:col-span-2"
          />
        </div>
      </div>

      <div className="sticky bottom-0 flex gap-3 border-t border-blue-100 bg-blue-50/90 px-4 py-3 sm:px-6 sm:py-4">
        <button
          type="button"
